...
layout: default
title: ModRef 2023
redirect_from: /ModRef2023.html
---

ModRef 2023 is the 22nd in a [series of workshops on Constraint Modelling and Reformulation](https://archive.modref.org) organized as part of CP 2023, the [29th International Conference on Principles and Practice of Constraint Programming](https://cp2023.a4cp.org/).
...
## <a name="pmodrefs"></a> Previous ModRefs

A searchable archive of all past ModRef workshops, papers and slides is available at [archive.modref.org](https://archive.modref.org).
